...
class ClientDelegate {
  ...
  _i1.ActionClient<Iterable<_i2.CreateManyClientAndReturnOutputType>>
      createManyAndReturn({
    required _i1.PrismaUnion<_i3.ClientCreateManyInput,
            Iterable<_i3.ClientCreateManyInput>>
        data,
    bool? skipDuplicates,
    _i3.CreateManyClientAndReturnOutputTypeSelect? select,
  }) {
    final args = {
      'data': data,
      'skipDuplicates': skipDuplicates,
    ...
    return _i1.ActionClient<Iterable<_i2.CreateManyClientAndReturnOutputType>>(
      action: 'createManyClientAndReturn',
      result: result,
      factory: (values) => (values as Iterable)
          .map((e) => _i2.CreateManyClientAndReturnOutputType.fromJson(e)),
    );
  }
