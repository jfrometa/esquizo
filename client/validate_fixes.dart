...
bool testAppCheckForUrlChangesDisabled() {
  ...
  try {
    ...
    if (content
            .contains('URL check disabled to prevent navigation conflicts') &&
...
bool testCurrentRouteLocationProviderSimplified() {
  ...
  try {
    ...
    if (content.contains('SIMPLIFIED: Direct WebUtils access') &&
        content.contains('WebUtils.getCurrentPath()')) {
