...
import 'package:starter_architecture_flutter_firebase/utils/string_to_locale_helper.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:intl/intl_standalone.dart'
    if (dart.library.html) 'package:intl/intl_browser.dart';

class TeapaymentLocalizationController extends ChangeNotifier {
  TeapaymentLocalizationController({
  ...
  Future loadTranslationData(Locale locale) async {
    final uri = Uri.parse(
      'https://teapayment-thanos.s3.eu-west-3.amazonaws.com/locale/${locale.languageCode}.json',
    );
