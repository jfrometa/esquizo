...
// @RoutePage()
class ManageCommunicationsScreen extends ConsumerStatefulWidget {
  const ManageCommunicationsScreen({super.key});

  @override
  ConsumerState<ManageCommunicationsScreen> createState() =>
      _ManageCommunicationsScreenState();
}

class _ManageCommunicationsScreenState
    extends ConsumerState<ManageCommunicationsScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const Center(
        child: Text('ManageCommunicationsScreen'),
      ),
    );
  }
}
