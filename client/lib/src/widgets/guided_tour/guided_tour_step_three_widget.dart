...
class GuidedTourStepThreeWidget extends ConsumerWidget {
  const GuidedTourStepThreeWidget({super.key});
      ...
      children: [
        Expanded(
          child: SvgPicture.asset(
            'assets/guided_tour_step_three_image.svg',
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'guide_tour.step_3.title'.t(),
                  style: customAppTheme.textStyles.displaySmall,
                ),
                const SizedBox(height: 10),
                Text(
                  'guide_tour.step_3.description'.t(),
