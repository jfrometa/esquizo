...
@riverpod
class UnifiedCateringPackageRepository extends _$UnifiedCateringPackageRepository {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  @override
  Stream<List<CateringPackage>> build() {
    // ALPHA: Core implementation present in all repositories
    return _firestore
  ...
  Future<List<CateringPackage>> getPackagesForOrder(List<String> packageIds) async {
...
final allCateringPackagesProvider = 
  ...
  final repository = ref.read(unifiedCateringPackageRepositoryProvider.notifier);
...
final packagesByCategoryProvider = 
  ...
  return ref.watch(unifiedCateringPackageProvider).getPackagesByCategory(categoryId);
});
...
final packagesForOrderProvider = 
    FutureProvider.family<List<CateringPackage>, List<String>>((ref, packageIds) async {
  return ref.watch(unifiedCateringPackageProvider).getPackagesForOrder(packageIds);
});

// Correct way to access the repository in modern Riverpod
extension UnifiedCateringPackageRepositoryX on 
...
final selectedPackageProvider = 
    StateNotifierProvider<SelectedCateringPackageNotifier, CateringPackage?>((ref) {
...
@Deprecated('Use selectedCateringPackageProvider instead')
final selectedPackageEmptyProvider = 
    Provider<CateringPackage>((ref) {
