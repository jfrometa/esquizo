...
class BusinessConfig {
  ...
  factory BusinessConfig.fromFirestore(DocumentSnapshot doc) {
    ...
    return BusinessConfig(
      ...
      contactInfo: Map<String, dynamic>.from(data['contactInfo'] as Map<dynamic, dynamic>? ?? {}),
      address: Map<String, dynamic>.from(data['address'] as Map<dynamic, dynamic>? ?? {}),
      hours: Map<String, dynamic>.from(data['hours'] as Map<dynamic, dynamic>? ?? {}),
...
class BusinessConfigService {
  ...
  Future<void> createBusinessConfigWithId(String id, BusinessConfig config) async {
    try {
      await _firestore
          .collection('businesses')
          .doc(id)
  ...
  Future<void> updateBusinessThemeColors(
    ...
    try {
      ...
      final currentSettings = businessDoc.data()?['settings'] as Map<dynamic, dynamic>? ?? {};
