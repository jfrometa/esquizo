...
// // Enhanced RestaurantTable model
...
// Enhanced restaurant stats model
...
// Update the restaurant stats provider
...
// Update the TableService methods to include cleaningTables
extension TableServiceStatsExtension on TableService {
  Future<TableStats> getTableStats() async {
    ...
    return TableStats(
      totalTables: 8,
      occupiedTables: 2,
      cleaningTables: 1, reservedTables: 0,
    );
  }
}