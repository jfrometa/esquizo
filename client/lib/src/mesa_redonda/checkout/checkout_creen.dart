...
class CheckoutScreenState extends ConsumerState<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isDarkMode 
        ...
        : ColorsPaletteRedonda.background ?? Colors.grey[50];
    final cardBackgroundColor = isDarkMode ? Colors.grey[850] : Colors.white;
    final textColor = isDarkMode ? Colors.white : ColorsPaletteRedonda.deepBrown1;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(
          color: isDarkMode ? Colors.white : ColorsPaletteRedonda.primary,
        ),
        title: Column(
          children: [
            Text(
            ...
            _buildProgressIndicator(totalSteps, isDarkMode),
          ],
        ),
      ),
      body: SafeArea(
  ...
  Widget _buildProgressIndicator(int totalSteps, bool isDarkMode) {
    return Row(
  ...
  Widget _buildStepTitle(Color textColor) {
    String title;
    switch (_currentStep) {
      case 0:
  ...
  Widget _buildCurrentStepContent(
    ...
    switch (_currentStep) {
      case 0:
        return _buildDeliveryStep(isDarkMode, cardBackgroundColor);
      case 1:
        return widget.displayType == 'quote' && totalSteps == 2
            ? _buildFinalSummaryStep(isDarkMode, cardBackgroundColor, textColor, subtitleColor)
            : _buildPaymentStep(isDarkMode, cardBackgroundColor, textColor, subtitleColor);
      case 2:
        return _buildFinalSummaryStep(isDarkMode, cardBackgroundColor, textColor, subtitleColor);
      default:
        return const SizedBox.shrink();
    }
  }

  Widget _buildDeliveryStep(bool isDarkMode, Color cardBackgroundColor) {
    return Card(
      elevation: 2,
      color: cardBackgroundColor,
      ...
      child: Padding(
        ...
        child: _buildCheckoutContent(isDarkMode),
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildPaymentOptions(isDarkMode, subtitleColor, textColor),
          ],
        ),
      ),
    );
  ...
  Widget _buildPaymentOptions(
    ...
    return Column(
      children: List.generate(
        ...
        (index) => _buildPaymentOption(index, isDarkMode, subtitleColor, textColor),
      ),
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isSelected 
              ? (isDarkMode 
                  ? ColorsPaletteRedonda.primary.withOpacity(0.2)
                  : ColorsPaletteRedonda.primary.withOpacity(0.05))
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                _buildOrderDetails(isDarkMode, subtitleColor, textColor),
              ],
            ),
          ),
        ),
            ...
            Expanded(
              ...
              child: OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side: BorderSide(color: ColorsPaletteRedonda.primary),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(8),
                  ),
                ),
  ...
  Widget _buildCheckoutContent(bool isDarkMode) {
    // Fetch items based on displayType
    final List<CartItem> cartItems = ref.watch(cartProvider) ?? [];
    final CateringOrderItem? cateringOrder = ref.watch(cateringOrderProvider);
    final CateringOrderItem? cateringQuote = ref.watch(manualQuoteProvider);
